...
public class VisualizarServicosMarcadosController {
	@GetMapping("/")
	public ModelAndView loadMyServices(RedirectAttributes redirectAttributes, HttpSession session) {
        ...
        try {
            ...
            if(servicosAgendados.size() == 0){
                ...
                modelAndView.addObject("messagePets", "Voce nao possui servicos cadastrados :/");
            } else {
