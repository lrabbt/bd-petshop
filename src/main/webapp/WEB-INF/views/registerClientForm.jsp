...
<body>
	<center>
		...
		<form:form action="/cadastrarCliente/cadastraCliente" name="meuForm" class="formValidate" id="formValidate" method="post"  novalidate="novalidate" modelAttribute="cliente">
