...
<body>
	<center>
		...
		<form:form action="/Petshop/cadastrar/cadastraCliente" name="meuForm"
			class="formValidate" id="formValidate" method="post"
			novalidate="novalidate" modelAttribute="cliente">
			<br />
			<br />
			...
			<form:input id="uname" placeholder="Nome" name="uname" type="text"
				data-error=".errorTxt1" path="nome" maxlength="50" />
			</br>
			</br>
			<div class="errorTxt1"></div>

			<label for="cemail">E-Mail *</label>
			<form:input id="cemail" placeholder="usuario@email.com" type="text"
				name="cemail" data-error=".errorTxt2" path="email" maxlength="50" />
			</br>
			</br>
			...
			<form:input id="cpf" placeholder="000.000.000-00" type="text"
				name="cpf" data-error="" path="cpf" maxlength="14" />
			</br>
			</br>
			<div class=""></div>

			<label for="end">Endere?o *</label>
			<form:input id="end" type="text"
				placeholder="Rua do usuario, 000. apt:000" name="end" data-error=""
				path="endereco" maxlength="50" />
			</br>
			</br>
			<div class=""></div>

			<label for="data">Data de Nascimento *</label>
			<form:input id="data" type="text" placeholder="dd-mm-aaaa"
				name="data" data-error="" path="dataNasc" maxlength="10" />
			</br>
			</br>
			<div class=""></div>
			...
			<form:input id="tel1" placeholder="(00) 00000-0000" type="text"
				class="validate" path="telefone1" maxlength="14" />
			</br>
			</br>

			<i class="material-icons prefix"></i>
			<label for="tel2">Telefone 2:</label>
			<form:input id="tel2" placeholder="(00) 00000-0000" type="text"
				class="validate" path="telefone2" maxlength="14" />
			</br>
			</br>

			<i class="material-icons prefix"></i>
			<label for="tel3">Telefone 3:</label>
			<form:input id="tel3" placeholder="(00) 00000-0000" type="text"
				class="validate" path="telefone3" maxlength="14" />
			</br>
			</br>
			...
			<form:input id="password" type="password" name="password"
				data-error=".errorTxt3" path="senha" />
			</br>
			</br>
			<div class="errorTxt3"></div>

			<label for="cpassword">Confirm Password *</label>
			<form:input id="cpassword" type="password" name="cpassword"
				data-error=".errorTxt4" path="" />
			</br>
			</br>
			<div class="errorTxt4"></div>
		...
		<pre></pre>
		<button onclick="window.location.href='/Petshop/login/'">Voltar</button>
		<br />
	</center>
